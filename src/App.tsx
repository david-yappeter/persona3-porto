...
const MENU_ITEMS: MenuEntry[] = [
  { label: 'SKILL', indent: 0.35, scale: 1.0, rot: -7, skew: -14 },
  { label: 'ITEM', indent: 0.3, scale: 1.02, rot: -11, skew: -9 },
  { label: 'EQUIP', indent: 0.4, scale: 1.0, rot: -6, skew: -16 },
  { label: 'PERSONA', indent: 0.0, scale: 1.06, rot: -9, skew: -11 },
  { label: 'STATS', indent: 0.6, scale: 0.98, rot: -13, skew: -13 },
  { label: 'QUEST', indent: 0.3, scale: 0.98, rot: -7, skew: -17 },
  { label: 'SOCIAL LINK', indent: 0.4, scale: 1.04, rot: -10, skew: -10 },
  { label: 'CALENDAR', indent: 0.1, scale: 1.04, rot: -6, skew: -15 },
  { label: 'SYSTEM', indent: 0.45, scale: 1.0, rot: -12, skew: -12 },
]
